...
function refreshItemBuff(keys,flag)
    ...
    local item_damage_b_percent_base = ability:GetSpecialValueFor("item_damage_b_percent_base")
    ...
    setPlayerPower(playerID, "player_damage_b_percent_base", flag, item_damage_b_percent_base)
